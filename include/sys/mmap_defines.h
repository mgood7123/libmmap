...
#if !defined(_OFF_T_) && (!defined(_FILE_OFFSET_BITS_SET_OFFT) && !(!defined(NO_OLDNAMES) || defined(_POSIX))) && (defined(_OFF_T_DEFINED) && !(defined _CRT_DECLARE_NONSTDC_NAMES && _CRT_DECLARE_NONSTDC_NAMES) || (!defined _CRT_DECLARE_NONSTDC_NAMES && !__STDC__))
